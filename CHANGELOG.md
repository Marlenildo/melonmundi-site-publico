...
## [1.0.17] - 2026-02-20
### Fixed
- Definido o título institucional da aba do navegador via `website.title` no `_quarto.yml`.
- Ocultado o texto da marca na navbar (`.navbar-title`), mantendo somente a logo.
- Preservado o comportamento da home com navbar transparente no topo e translúcida ao rolar.
- Regerados os arquivos em `docs/` para publicação.
